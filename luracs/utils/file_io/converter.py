...
def spectrogram_exporter(parser: db_parser, file_type: str, new_name: str, include_spectrogram_data: bool = False):
    ...
    _write_logged_data_to_xlsx(ws3, parser.get_spectrogram_by_date(), include_spectrogram_data)
