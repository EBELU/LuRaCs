...
cs137temp = np.array([
32, 47, 49, 68, 70, 63, 69, 69, 70, 81, 78, 64, 52, 44, 39, 35,
32, 30, 29, 28, 28, 27, 25, 19, 13, 8, 6, 5, 5, 5, 9, 21,
40, 44, 27, 10, 4, 1,
...
class MockClient:
    ...
    def LatestSpectrum(self):
        ...
        return SpectrumResult(
               self.spect_buf.copy(),  time.time() - self.start_ts, [0.0003705, 2.3694975, 4.2583089], time.time())
