...
from PySide6.QtWidgets import QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QHBoxLayout, QMessageBox, QComboBox, QTextEdit, QSizePolicy, QLabel, QTableWidget, QTableWidgetItem
...
class CurrentValuesPlot(QWidget):
    ...
    def receive_data_packet(self, name, packet):
        ...
        if name not in self.dose_queues:
            ...
            if pen is None: pen = self.color_rotation.next_pen()
